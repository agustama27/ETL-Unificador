...
carpeta_calls = Path("C:/Users/agustin/Desktop/soho-bancor-cobranzas-etl/back-cargaMasiva/calls")
```
...
- **Language**: Spanish is acceptable for domain-specific terms (`gestiones`, `tipificación`); English for technical terms.
