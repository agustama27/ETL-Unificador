...
def test_repository_registry_directory_exposes_all_client_entries() -> None:
    ...
    assert {item.id for item in inert} == {"bancor.resultados.retell", "bancor.carga_masiva",
                                       "bancor.cupones", "epec.tipif.retell"}
